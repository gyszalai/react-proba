...
/***/ function(module, exports, __webpack_require__) {
	...
	var _middlewares = __webpack_require__(183);
	...
	var counter = function counter() {
	    ...
	    switch (action.type) {
	        case 'INCREMENT':
	            return _extends({}, state, { counter: state.counter + action.howMany });
	        case 'DECREMENT':
	            return _extends({}, state, { counter: state.counter - action.howMany });
	        default:
	            return state;
	...
	var store = (0, _redux.createStore)(counter, (0, _redux.applyMiddleware)(_middlewares.logger, _middlewares.crashReporter));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Note = __webpack_require__(170);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_Note2.default, { valami: 'HUTYUTYU' }),
	...
	App.propTypes = {
	  valami: _react2.default.PropTypes.string
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var increment = function increment(howMany) {
	    return {
	        type: 'INCREMENT',
	        howMany: howMany
	    };
	...
	var decrement = function decrement(howMany) {
	    return {
	        type: 'DECREMENT',
	        howMany: howMany
	    };
